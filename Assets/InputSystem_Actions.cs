...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""CameraLook"",
            ""id"": ""73ca246f-9b11-494d-a357-08342e32c9ec"",
            ""actions"": [
                {
                    ""name"": ""MouseDelta"",
                    ""type"": ""Button"",
                    ""id"": ""d9334b6c-6068-484b-a95e-981c4689df5f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""168e5f36-4d15-41e0-8c36-c8a4cbbe045d"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_CameraLook_MouseDelta = m_CameraLook.FindAction("MouseDelta", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_CameraLook.enabled, "This will cause a leak and performance issues, InputSystem_Actions.CameraLook.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_CameraLook_MouseDelta;
    /// <summary>
    /// Provides access to input actions defined in input action map "CameraLook".
    /// </summary>
    public struct CameraLookActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public CameraLookActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "CameraLook/MouseDelta".
        /// </summary>
        public InputAction @MouseDelta => m_Wrapper.m_CameraLook_MouseDelta;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="CameraLookActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="CameraLookActions" />
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="CameraLookActions.UnregisterCallbacks(ICameraLookActions)" />.
        /// </summary>
        /// <seealso cref="CameraLookActions.UnregisterCallbacks(ICameraLookActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="CameraLookActions.AddCallbacks(ICameraLookActions)" />
        /// <seealso cref="CameraLookActions.RemoveCallbacks(ICameraLookActions)" />
        /// <seealso cref="CameraLookActions.UnregisterCallbacks(ICameraLookActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="CameraLookActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "CameraLook" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="CameraLookActions.AddCallbacks(ICameraLookActions)" />
    /// <seealso cref="CameraLookActions.RemoveCallbacks(ICameraLookActions)" />
